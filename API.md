...
- Sets recruitment size (sqrt of n_cells)
...
#### `.obsm` matrices
- `dummy_label`: Probabilistic labels (cells x terminal states)
...
```python
# See: analysis/Setty/SCOPE-Setty.py
...
```python
# See: analysis/Persad/RNA/SCOPE-Persad-RNA.py
...
### LARRY (Weinreb et al.)
```python
# See: analysis/Weinreb/SCOPE-Larry.py
