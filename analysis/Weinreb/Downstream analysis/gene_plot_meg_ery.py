...
ery_path = os.path.join(data_folder, "larry_variable_importance_ery.csv")
meg_path = os.path.join(data_folder, "larry_variable_importance_Meg.csv")

ERY_COL = "weighted_importance_ery"
MEG_COL = "weighted_importance_Meg"

highlight_genes = ["Tfrc", "Gata2", "Itga2b"]
highlight_colors = {"Tfrc": "#8D72AD", "Gata2": "#55AFA9", "Itga2b": "#A0522D"}
...
# ---------------- DATA ----------------
ery = prep_curve(ery_path, ERY_COL, "Erythroid")
meg = prep_curve(meg_path, MEG_COL, "Megakaryocyte")
...
# Plot 1: Erythroid
ax1.scatter(ery["rank"], ery["value"], s=8, alpha=0.7, color="#1f77b4")
annotate_highlights(ax1, ery, "#1f77b4")
ax1.set_title("Erythroid", fontsize=20)
ax1.set_xlabel("Rank (decreasing value)", fontsize=20)
ax1.set_ylabel("teststat", fontsize=20)
ax1.tick_params(labelsize=20)

# Plot 2: Megakaryocyte
ax2.scatter(meg["rank"], meg["value"], s=8, alpha=0.7, color="#ff7f0e")
annotate_highlights(ax2, meg, "#ff7f0e")
ax2.set_title("Megakaryocyte", fontsize=20)
ax2.set_xlabel("Rank (decreasing value)", fontsize=20)
ax2.set_ylabel("teststat", fontsize=20)
ax2.tick_params(labelsize=20)

plt.tight_layout()
output_path = os.path.join(data_folder, "gene_plot_meg_ery.pdf")
