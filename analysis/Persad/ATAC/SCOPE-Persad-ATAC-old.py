...
# Load data
data = ad.read_h5ad('/home/yzhao4/new_repo_branchpoint/Data/Seacell_HSPC/data_process_pipeline_basedon_seacell/process_atac_gata2_enhancer/filter_peak_corr/cd34_multiome_atac_palantir_mellon_without_cDC_CLP.h5ad')
...
while np.sum(data.obs['visit']) < data.n_obs:
    ...
    X_train = data[train_ind].obsm['imputed_peaks'].copy()
    X_test = data[test_ind].obsm['imputed_peaks'].copy()
    X_cal = data[cal_ind].obsm['imputed_peaks'].copy()
