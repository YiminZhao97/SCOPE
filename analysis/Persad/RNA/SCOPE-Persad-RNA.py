"""
Updated version based on spreading_emmanuel_new.py logic
"""
import sys
...
from classifier import train_and_predict_rf, convert_prediction_indices_to_state_names
...
# Load data
#data = ad.read_h5ad('/home/yzhao4/new_repo_branchpoint/Data/Seacell_HSPC/data_seacell_pipeline/cd34_multiome_rna_palantir_without_cDC_CLP_vae.h5ad')
...
# Process data similar to warmstart version but adapted for this dataset
