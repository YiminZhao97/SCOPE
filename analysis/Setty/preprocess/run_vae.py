...
#load data
data = ad.read_h5ad('/home/yzhao4/new_repo_branchpoint/Data/Palantir_bone_marrow/data/data_palantir_pseudotime_leiden_clustering_mellon.h5ad')
...
train(model, trainloader = train_loader, validloader = valid_loader, device = device, patience = 20, savepath = '/home/yzhao4/new_repo_branchpoint/Data/Palantir_bone_marrow/data_pipeline')
...
data.write_h5ad('/home/yzhao4/new_repo_branchpoint/Data/Palantir_bone_marrow/data/data_palantir_pseudotime_leiden_clustering_mellon_vae.h5ad')